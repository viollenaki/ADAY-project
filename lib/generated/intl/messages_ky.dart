...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "expenseOverview": MessageLookupByLibrary.simpleMessage(
    ...
    "incomeOverview": MessageLookupByLibrary.simpleMessage(
      "Киреше жөнүндө сереп",
    ),
    ...
    "monthlySpendingTrends": MessageLookupByLibrary.simpleMessage(
      "Айлык чыгаша тенденциялары",
    ),
    "noDataAvailable": MessageLookupByLibrary.simpleMessage(
      "Жеткиликтүү маалымат жок",
    ),
